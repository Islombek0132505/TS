...
(function (PaymentProvider) {
    PaymentProvider[PaymentProvider["Uzum"] = 0] = "Uzum";
    PaymentProvider[PaymentProvider["Click"] = 1] = "Click";
    PaymentProvider[PaymentProvider["Payme"] = 2] = "Payme";
})(PaymentProvider || (PaymentProvider = {}));
var PaymentProcess;
(function (PaymentProcess) {
    PaymentProcess[PaymentProcess["Pending"] = 0] = "Pending";
    PaymentProcess[PaymentProcess["Approved"] = 1] = "Approved";
    PaymentProcess[PaymentProcess["Rejected"] = 2] = "Rejected";
})(PaymentProcess || (PaymentProcess = {}));
class Student {
    constructor(name, surname, age, univer) {
        this.age = age;
        this.name = name;
...
class Payment {
    constructor(student, paymentProcess, paymentProvider) {
...
class PaymentsData {
    ...
    getStudentsWithProvider(provider) {
...
const paymentsData = new PaymentsData([payment1, payment2, payment3, payment4]);
